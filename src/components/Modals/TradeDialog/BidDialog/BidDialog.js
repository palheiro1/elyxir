...
const BidDialog = ({ reference, isOpen, onClose, card, username }) => {
				...
				<AlertDialogContent bgColor="#1D1D1D" border="1px" borderColor="whiteAlpha.400" shadow="dark-lg">
					...
					<AlertDialogBody>
						<VStack>
							...
							<Box w="100%">
								<AskAndBidGrid askOrders={(card.askOrders).slice(0,3)} bidOrders={(card.bidOrders).slice(0, 3)} onlyText={true} />
							</Box>
						</VStack>
					</AlertDialogBody>
