...
const NewsAirdrops = () => {
    ...
    const airdrops = useMemo(() => [
        ...
        { id: '8066924493903893072', name: 'Lightning Essence', type: 'ingredient', chain: 'Ardor', active: true, description: 'Capture lightning during thunderstorms', image: '/images/elyxir/ingredients/lightninggg.png', requirement: 'Storm events', method: 'Weather-based' },
        ...
        { id: '8066924493903893072', name: 'Sunlight Essence', type: 'ingredient', chain: 'Ardor', active: true, description: 'Dawn ceremony participants receive sunlight', image: '/images/elyxir/ingredients/sunlight.png', requirement: 'Dawn ceremony', method: 'Ceremonial rewards' },
