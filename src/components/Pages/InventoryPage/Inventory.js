...
const Inventory = ({ infoAccount }) => {
    ...
    const fakeAssets = useMemo(() => {
        ...
        const tools = [
            ...
            {
                name: 'Silver Ladle',
                description: 'For transferring potions into flasks',
                image: 'ladle.png',
                key: 'ladle',
            },
            {
        ...
        const recipes = [
            {
                name: 'Recipe of the Whispering Gale Potion',
                description: 'Ancient formula for aerial enhancement',
                image: 'recipe1.png',
                key: 'recipe_whispering_gale',
            },
            {
                name: 'Recipe of the Tideheart Potion',
                description: 'Aquatic power brewing instructions',
                image: 'recipe2.png',
                key: 'recipe_tideheart',
            },
            {
                name: 'Recipe of the Stoneblood Potion',
                description: 'Terrestrial strength elixir formula',
                image: 'recipe1.png',
                key: 'recipe_stoneblood',
            },
            {
                name: 'Recipe of the Eternal Silk Potion',
                description: 'Asiatic wisdom brewing guide',
                image: 'recipe2.png',
                key: 'recipe_eternal_silk',
            },
            {
                name: 'Recipe of the Coral Spirits Potion',
                description: 'Oceanic essence creation method',
                image: 'recipe1.png',
                key: 'recipe_coral_spirits',
            },
            {
                name: 'Recipe of the Feathered Flame Potion',
                description: 'Americas spirit brewing technique',
                image: 'recipe2.png',
                key: 'recipe_feathered_flame',
            },
            {
                name: 'Recipe of the Shifting Dunes Potion',
                description: 'African power enhancement formula',
                image: 'recipe1.png',
                key: 'recipe_shifting_dunes',
            },
            {
                name: 'Recipe of the Forgotten Grove Potion',
                description: 'European strength elixir guide',
                image: 'recipe2.png',
                key: 'recipe_forgotten_grove',
            },
        ].map((recipe, index) => {
    ...
    const allItemsForSection = useMemo(() => {
        ...
        if (section === 'INGREDIENT') {
            ...
            const realPotions = items
                .filter(item => ELYXIR_POTIONS.some(potion => potion.assetId === item.asset))
                .map(item => ({
                    ...item,
    ...
    const filterBySection = useCallback(
        (base = allItemsForSection, sec = section) => {
            if (sec === 'INGREDIENT') {
