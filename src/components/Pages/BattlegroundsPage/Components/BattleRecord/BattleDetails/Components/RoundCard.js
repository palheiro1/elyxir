 ...
 */
const RoundCard = ({ card, soldier, bonus, roll, isWinner, isHero, isMobile, cardImgUrl, rollIcon, defenseBonus }) => (
    <Stack direction="row" w="95%">
        <Stack direction="column" m="auto">
            <Stack direction="row">
                <Image boxSize="20px" borderRadius="5px" p={0.5} bgColor="#FFF" src={getContinentIcon(card.channel)} />
