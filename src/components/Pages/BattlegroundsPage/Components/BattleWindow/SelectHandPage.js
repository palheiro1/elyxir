    ...
    return (
        <>
            <Box display={'flex'} flexDir={'column'} overflowY={'scroll'} maxH={'95%'} className="custom-scrollbar">
                ...
                {/* Potion Selection Section */}
                <Stack direction={'row'} mx={'auto'} mt={isMobile ? 3 : 6} w={isLowHeight ? '90%' : '70%'}>
                    <Text
                        color={'#FFF'}
                        textAlign={'center'}
                        my={'auto'}
                ...
                <Stack direction={'row'} mx={'auto'} mt={3} justifyContent={'center'}>
                    {selectedPotion ? (
                        <Box 
                            position="relative" 
                        ...
                        <Box
                            ...
                            gap="15px"
                            display="flex"
                            border="2px dashed #D08FB0"
                            borderRadius="8px"
                            onClick={() => {
                                // Mock potion selection - in real app this would open a potion picker
                                const mockPotion = {
                                    id: 'healing_potion_1',
                                    name: 'Healing Potion',
                                    image: '/images/items/healing-potion.png',
                                    type: 'Healing',
                                    rarity: 'Common',
                                    effect: '+50 HP'
                                };
                                setSelectedPotion(mockPotion);
                            }}
                        >
                            <Stack direction="column" alignItems="center" justifyContent="center" w="100%">
                                <Text
                                    fontFamily={'Chelsea Market, system-ui'}
                                    fontSize={'xl'}
                                    color={'#FFF'}
            ...
            <Modal isOpen={isOpen} onClose={onClose} isCentered>
                ...
                <ModalContent bgColor={'#ebb2b9'} border={'2px solid #F48794'}>
                    <ModalHeader mx={'auto'}>Battle Confirmation</ModalHeader>
                    <ModalCloseButton />
                    <ModalBody>
                        <Stack direction="column" spacing={4}>
                            <Text textAlign="center" fontWeight="bold">
                                Selected Cards: {handBattleCards.filter(card => card !== '').length}
                            </Text>
                            {selectedPotion && (
                                <Box textAlign="center">
                                    <Text fontWeight="bold" mb={2}>Selected Potion:</Text>
                                    <Stack direction="row" alignItems="center" justifyContent="center" spacing={2}>
                                        ...
                                        <Stack direction="column" spacing={0}>
                                            <Text fontWeight="bold">{selectedPotion.name}</Text>
                                            <Text fontSize="sm" color="gray.600">
                                                {selectedPotion.type} • {selectedPotion.effect}
                                            </Text>
                                        </Stack>
                                    </Stack>
                                </Box>
