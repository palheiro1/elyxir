...
const BridgeERC20Mana = ({ infoAccount, swapAddresses, manaCards }) => {
        ...
        <>
            ...
            <Center>
                <Box maxW="50%">
                    ...
                    {option === 1 && <SwapToPolygon infoAccount={infoAccount} ardorAddress={swapAddresses.ardor} manaCards={manaCards} />}
                </Box>
            </Center>
        </>
    );
...
export default BridgeERC20Mana;
